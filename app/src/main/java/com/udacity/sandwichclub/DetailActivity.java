...
public class DetailActivity extends AppCompatActivity {
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        for (String alsoKnownAs : sandwich.getAlsoKnownAs()) {
            if (alsoKnownAs.equals(sandwich.getAlsoKnownAs().get(sandwich.getAlsoKnownAs().size() - 1))) {
        ...
        for (String ingredients : sandwich.getIngredients()){
            if (ingredients.equals(sandwich.getIngredients().get(sandwich.getIngredients().size() - 1))) {
